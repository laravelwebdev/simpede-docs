...
<Step title="Unduh Template Surat Keluar dan Sesuaikan isinya">
    ...
    <Warning>
        Jangan menghapus atau mengubah bagian penutup surat dan tanda tangan berikut.
        <Frame caption="Tampilan Menu Penutup Surat">
            ![Penutup Surat](images/srikandi-penutup.png)
        </Frame>
    </Warning>
</Step>
<Step title="Masuk ke Aplikasi Srikandi">
    Buka aplikasi [Srikandi](https://srikandi.arsip.go.id/) dan masuk ke akun Anda.
</Step>
<Step title="Pilih Menu Naskah Keluar -> Registrasi Naskah Keluar">
<Frame caption="Tampilan Menu Registrasi Naskah Keluar">
    ![Menu Naskah Keluar](images/srikandi-registrasi.png)
</Frame>
</Step>
<Step title="Isi Bagian Keterangan Naskah Keluar">
    <Frame caption="Detail Registrasi Naskah Keluar">
    ...
    <Tip>
        ...
        <Frame caption="Pengisian Isi Ringkas">
...
<Step title="Kirim Naskah Keluar">
    Buka Menu `Naskah Keluar` -> `Log Naskah Keluar`, lalu cari naskah yang telah dibuat. Klik `Tombol Lihat` (Ikon Mata) pada record tersebut.
    <Frame caption="Log Naskah Keluar">
        ![Menu Log](images/srikandi-log.png)
    </Frame>
    <Frame caption="Tampilan Menu Lihat">
        ![Tombol Mata](images/srikandi-lihat.png)
    </Frame>
    Selanjutnya klik Tombol `Kirim Konsep` .
    <Frame caption="Tampilan Kirim Konsep">
