...
Untuk mengubah Naskah Keluar, tekan `Tombol Sunting` pada record yang akan diubah.

## Menghapus

Untuk menghapus Naskah Keluar, tekan `Tombol Hapus` pada record yang akan dihapus.
