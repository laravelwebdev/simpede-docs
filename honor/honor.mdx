...
Ikuti langkah berikut Untuk menggenerate file excel yang akan digunakan untuk diimport ke Aplikasi BOS.
  ...
  <Step title="Import Template pada Aplikasi BOS">
    Import file excel yang telah diexport ke dalam Aplikasi BOS. Jangan lupa memberi ceklis pada pilihan `Terdapat Daftar Mitra SOBAT BPS`.
...
Untuk mencetak SPJ, Surat Tugas maupun SK dapat dilakukan dengan cara menekan `Tombol Aksi` pada record yang akan dicetak, kemudian pilih aksi yang sesuai.
