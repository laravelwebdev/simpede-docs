...
Pembuatan Surat Tugas dan SK dilakukan dengan mengklik `Tombol Sunting` pada tabel Honor Kegiatan. Beri ceklis pada pilihan `Buat Surat Tugas` untuk membuat Surat Tugas dan beri ceklis pada pilihan `Buat Surat Keputusan (SK)` untuk membuat SK.
...
<Steps>
  ...
  <Step title="Tambahkan Daftar Honor Mitra">
   Penambahan Daftar Honor Mitra dapat dilakukan melalui `Halaman Detail` tab `Daftar Honor Mitra` dan memilih aksi `Import dari BOS`.
    ...
    <Warning>
      Template Excel yang diimport boleh diisi terlebuh dahulu boleh dikosongkan. Jika ingin menggunakan template yang sudah tersisi, beri tanda cek pada `Template Terisi`.
    <Frame caption="Pilihan apabila menggunakan template yang telah terisi`">
        ![Import BOS](../images/template-terisi.png)
    </Frame>
    </Warning>
    <Tip>
    ...
    <Warning>
      Sebelum mencetak SPJ, pastikan semua nomor rekening pada daftar honor mitra telah terisi. Apabila masih ada yang kosong, ubah terlebih dahulu dengan mengklik `Tombol Aksi` dan pilih `Edit Rekening`.
  ...
  <Step title="Tambahkan Daftar Honor Pegawai">
   Penambahan Daftar Honor Mitra dapat dilakukan melalui `Halaman Detail` tab `Daftar Honor Pegawai` dan memilih tombol `Buat Daftar Honor Pegawai`.
    ...
    <Warning>
      Jika pegawai menerima honor, sebelum mencetak SPJ, pastikan semua nomor rekening pada daftar honor pegawai telah terisi. Apabila masih ada yang kosong, ubah terlebih dahulu dengan mengklik `Tombol Aksi` dan pilih `Edit Rekening`.
    <Frame caption="Mengubah Nomor Rekening">
...
<Steps>
  <Step title="Export Template BOS">
    Export template Excel dengan mengklik `Tombol Aksi` dan pilih `Export Template BOS`.
...
Ada 2 jenis file csv yang dapat diexport yaitu untuk transfer ke sesama rekening BRI (MASS FT) dan transfer ke bank lain (MASS CN). 
...
Pencetakan SPJ, Surat Tugas maupun SK dapat dilakukan dengan cara mengklik `Tombol Aksi` pada record yang akan dicetak, kemudian pilih aksi yang sesuai.
