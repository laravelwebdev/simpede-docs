...
## Ekspor csv untuk CMS BRI
Ada 2 jenis file csv yang dapat dieksport yaitu untuk transfer ke sesama rekening BRI (Mass FTP) dan transfer ke bank lain (Mass CN). 
Untuk melakukan ekspor, pilih `Tombol Aksi` dan pilih `Ekspor Template CMS BRI MASS FT` atau `Ekspor Template CMS BRI MASS CN`.
  <Frame caption="Eksport Template CMS BRI">
