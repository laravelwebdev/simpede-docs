...
<Steps>
    ...
    Sebelum dapat menggenerate kontrak, terlebih dahulu keterangan kontrak harus diubah. Untuk mengubah kontrak dapat dilakukan melalui menu `Kontrak Mitra` -> `Kontrak` kemudian klik `Tombol Sunting` pada record yang akan diubah.
