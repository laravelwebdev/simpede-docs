...
<Steps>
    ...
    Sebelum dapat menggenerate BAST, terlebih dahulu keterangan BAST harus diubah. Untuk mengubah BAST dapat dilakukan melalui menu `Manajemen` -> `BAST Mitra` kemudian klik `Tombol Sunting` pada record yang akan diubah.
