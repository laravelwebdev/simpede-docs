...
Untuk mengubah BAST Kontrak Mitra dapat dilakukan dengan cara klik `Tombol Sunting` pada record yang akan diubah.

## Menghapus

Untuk menghapus BAST Kontrak Mitra dapat dilakukan dengan cara klik `Tombol Hapus` pada record yang akan dihapus.
