...
<Steps>
  ...
  <Step title="Melengkapi Rincian Barang Yang Diterima">
    ...
    <Tip>
       Menambahkan rincian barang persediaan juga dapat dilakukan dengan mengklik `Tombol Aksi` pada record yang akan ditambahkan rincian barangnya. Selanjutnya pilih aksi `Import dari KAK`. Dengan cara ini, Anda tidak perlu menambahkan satu per satu barang yang diterima.
    ...
    Setelah barang persediaan ditambahkan sesuai dengan barang yang diterima. Pejabat PBJ menandai bahwa barang telah diterima dengan mengklik `Tombol Aksi` dan memilih aksi `Terima Barang`
...
<Tip>
    Anda dapat mengklik tombol papan clipboard untuk menyalin kode barang.
