...
<Tip>
    Jika kode barang persediaan belum ada pada Master Barang Persediaan, Anda dapat langsung menambahkan dengan mengklik tombol <i class="fa-solid fa-circle-plus"></i>.
