---
title: "Arsip dan Dokumentasi Digital"
icon : "envelopes-bulk"
description: "Pengelolaan Softcopy Arsip Dokumen dan Dokumentasi"
---

## Kewenangan Pengguna
Arsip yang telah bertanda tangan perlu di-scan dan di-upload untuk pengarsipan.
Berikut adalah pengguna yang dapat melakukan upload arsip dokumen berdasarkan kewenangan.
...
| Naskah Masuk (Opsional)          | Pegawai, Ketua Tim, Kepala, Arsiparis |
| Naskah Keluar (Opsional)       | Pegawai, Ketua Tim, Kepala, Arsiparis |
...
| Undangan Rapat Internal | Pegawai              |
| Daftar Hadir Rapat Internal | Pegawai              |
| Notula Rapat Internal | Pegawai              |
| Dokumentasi Kegiatan| Pegawai              |
| Dokumentasi Link| Pegawai              |
...
<Warning>
   Pelampiran Kerangka Acuan hanya bisa dilakukan apabila Arsip SP2D dan SPM telah diupload.
</Warning>

### Kontrak Mitra 
<Note>
   Menu : `Kontrak` -> `Kontrak` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>
...
### Naskah Masuk
<Warning>
Pengelolaan arsip Naskah Masuk wajib dilakukan melalui Aplikasi SRIKANDI. Aplikasi Simpede bersifat opsional saja/ sebagai backup cadangan jika terjadi gangguan di aplikasi SRIKANDI. 
</Warning>
<Note>
   Menu : `Naskah Dinas` -> `Naskah Masuk` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>
 
### Naskah Keluar
<Warning>
Pengelolaan arsip Naskah Keluar wajib dilakukan melalui Aplikasi SRIKANDI. Aplikasi Simpede bersifat opsional saja/ sebagai backup cadangan jika terjadi gangguan di aplikasi SRIKANDI. 
</Warning>
<Note>
   Menu : `Naskah Dinas` -> `Naskah Keluar` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>
...
### BON Permintaan
<Note>
   Menu : `Persediaan` -> `BON Permintaan` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>

### Penerimaan Persediaan
<Note>
   Menu : `Persediaan` -> `Pembelian` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>

### Undangan, Daftar Hadir, Notula Rapat Internal
<Note>
   Menu : `Manajemen`  -> `Rapat Internal` 
   > Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>

## Dokumentasi
### Dokumentasi Kegiatan
Digunakan untuk mengelola foto-foto dokumentasi kegiatan.
<Note>
   Menu : `Dokumentasi`  -> `Foto Kegiatan` 
 </Note>

### Dokumentasi Link
Digunakan untuk mengelola link-link yang sering digunakan.
<Note>
   Menu : `Dokumentasi`  -> `Link` 
</Note>
