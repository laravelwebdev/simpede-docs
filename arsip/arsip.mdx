...
Digunakan untuk mengelola foto-foto dokumentasi kegiatan yang dilakukan oleh pegawai.
<Note>
   Menu : `Dokumentasi`  -> `Foto Kegiatan` 
   > Setelah daftar kegiatan dibuat, Gunakan `Tombol Edit` (<Icon icon="pen-to-square" />) untuk mengupload arsip dokumen.
</Note>
