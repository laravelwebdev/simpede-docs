...
Untuk mengubah Bon Permintaan dapat dilakukan dengan cara klik `Tombol Sunting` pada record yang akan diubah.

## Menghapus

Untuk menghapus Bon Permintaan dapat dilakukan dengan cara klik `Tombol Hapus` pada record yang akan dihapus.
