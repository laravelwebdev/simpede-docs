...
Penambahan Daftar Brang Persediaan yang akan diminta dapat dilakukan dengan mengakses `Halaman Detail` Bon Permintaan. Kemudian klik tombol `Buat Barang Persediaan`.
