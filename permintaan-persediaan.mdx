...
Pembuatan Bon Permintaan dapat dilakukan melalui menu `Bon Permintaan`. Pada Halaman Indeks tekan tombol `Buat Buat` yang terdapat pada bagian kanan tabel.
...
Pada saat menambhakan, ketik pada kolom pencarian untuk mencari jenis barang yang ingin diminta. 
<Warning>
