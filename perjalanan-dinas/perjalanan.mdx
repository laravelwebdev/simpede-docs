...
Untuk membuat nomor Surat Tugas dan Surat Perintah Perjalanan Dinas, dapat dilakukan dengan cara mengklik  `Tombol Sunting` pada record yang akan dibuat nomornya. Lengkapi Semua isian yang diperlukan.
...
Penambahan Daftar Peserta dapat dilakukan melalui `Halaman Detail` Perjalanan Dinas dan mengklik `Buat Daftar Peserta Perjalanan`.
...
Untuk mengubah Perjalanan Dinas dapat dilakukan dengan cara mengklik `Tombol Sunting` pada record yang akan diubah.

## Menghapus

Untuk menghapus Perjalanan Dinas dapat dilakukan dengan cara mengklik `Tombol Hapus` pada record yang akan dihapus.
