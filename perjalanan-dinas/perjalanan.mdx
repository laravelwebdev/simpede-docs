...
<Note>
Daftar Perjalanan Dinas tidak bisa ditambahkan jika terdapat anggaran perjalanan pada Kerangka Acuan Kerja. Untuk menambahkan perjalanan dinas, pada `Halaman Indeks` Kerangka Acuan, klik `Tombol Aksi` dan pilih `Tambahkan Perjalanan Dinas`.
