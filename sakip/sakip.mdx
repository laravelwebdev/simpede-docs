...
Untuk pencatatan target dan realisasi dapat dilakukan dengan klik tombol `Sunting` pada `Halaman Indeks` menu `Realisasi Kinerja`
...
Untuk pencatatan kendala dan solusi dapat dilakukan dengan klik tombol `Buat Kendala - Solusi` pada `Halaman Indeks` menu `Kendala - Solusi`
...
Untuk pencatatan rencana tindak lanjut dapat dilakukan dengan klik tombol `Buat Tindak Lanjut` pada `Halaman Indeks` menu `Tindak Lanjut`
