...
Untuk pencatatan target dan realisasi dapat dilakukan dengan mengklik tombol `Sunting` pada `Halaman Indeks` menu `Realisasi Kinerja`
...
<br />
   > Waktu Pengisian : Setiap Bulan
<br />
   > Menu : `SAKIP` -> `Kendala - Solusi`
</Note>
Untuk pencatatan kendala dan solusi dapat dilakukan dengan mengklik tombol `Buat Kendala - Solusi` pada `Halaman Indeks` menu `Kendala - Solusi`
...
Untuk pencatatan rencana tindak lanjut dapat dilakukan dengan mengklik tombol `Buat Tindak Lanjut` pada `Halaman Indeks` menu `Tindak Lanjut`
...
Tindak Lanjut yang telah dilaksanakan harus dilaksanakan dalam jangka waktu yang telah ditentukan. Untuk pencatatan pelaksanaan tindak lanjut dapat dilakukan dengan mengklik tombol `Buat Pelaksanaan Tindak Lanjut` pada `Halaman Detail` menu `Tindak Lanjut` tab `Pelaksanaan Tindak Lanjut` dan klik `Buat Pelaksanaan Tindak Lanjut`
